...
PEOPLE = (
    ...
    P('מכלוף ושלומון דהן', '1903 · 1922', 'אחיו של שלום; באותה רשימה, לקריית שמונה', '#s5-1', 'Makhlouf Maklouf Salomon Shlomon Dahan סמחה שמחה'),
