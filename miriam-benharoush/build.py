...
PEOPLE = (
    ...
    P('שלום דהן', '', 'אביה; ככל הנראה חייט במלאח הישן של מכנאס; לימים ירושלים',
      '#s6', 'Shalom Chalom Dahan דהאן חייט Tailleur Mellah'),
    P('יקוט דהן', '', 'אמה; לימים ירושלים', '#s6', 'Yakut Yacot Yacout Yakot יאקוט יקות Dahan'),
    P('רבקה דהן', 'נ׳ ~1943', 'אחותה; פנקס אליאנס 1950, עזבה אוקטובר 1955', '#s3-2', 'Rivka Rebecca Rébéca Rebeca Dahan'),
    P('רחל דהן', 'נ׳ ~1947', 'אחותה; פנקס אליאנס 1953', '#s3-3', 'Rachel Dahan'),
    P('מרדכי בן הרוש', '1931 – 2010', 'בעלה; בן יונה ויקוט, עלה 1947/48 — דף מחקר נלווה',
