...
*הערת קריאה: בערכי המהדורות 1–12 "S<n>" מציין את ערך n באינדקס המקורות דאז, ומספרי N שם הם לפי המספור הישן (N-6 של מהדורה 3 = N-4 היום); המספור אוחד במהדורה 13 ולא שוכתב לאחור.*
