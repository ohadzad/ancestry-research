...
- תיקון גלישת הכיתוב בצמתי עץ המשפחה (מנוע `treegen`), וקיצור תווית ארוכה; בעמוד הסיפור העץ מוצג עם מקרא הצבעים בלבד.

## מהדורה 24 · 13.09.2026
- **הזמנת החתונה, 12.9.1960** (מקור 13, [5.2](#s5-2)) — המשפחה מסרה את ההזמנה המודפסת הדו-לשונית. קובעת את **התאריך המדויק** של נישואיה למרדכי בן הרוש (טעון אימות → **מאומת**), ואת שמות הוריה — שלום ויקוט דהן — בכתיב עברי ובכתיב צרפתי, ממקור ישראלי; וכן את הכינוי MARIE, כבפנקס 1949.
- ציר הזמן בעמוד הסיפור נפתח כעת בדור שלפני הלידה (הסב חביב ובניו שלום, מכלוף ושלומון), לאחידות עם שאר המחקרים.
