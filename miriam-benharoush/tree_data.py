...
nodes = [
    ...
    N('rachelm', 2, 2, 'רחל דהן',           ['1941 · רמת הדסה · אליאנס 1949', 'בת מכלוף — ככל הנראה']),
    N('lorem',   3, 2, 'לורט(?) דהן',       ['1942 · רמת הדסה', 'בת מכלוף — ככל הנראה']),
    N('masoudi', 4, 2, 'מסעודי דהן',        ['1944 · רמת הדסה', 'בת מכלוף — ככל הנראה']),
