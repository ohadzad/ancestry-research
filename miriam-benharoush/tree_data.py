...
tree = Tree(
    ...
    title='עץ המשפחה — חביב ומרים דהן, יצחק ורבקה אבוטבול; שלום ויקוט דהן ובנותיהם מרים, רבקה ורחל; אחיו של שלום מכלוף על משפחתו ושלומון; בעלה של מרים מרדכי בן הרוש',
)
