...
**הזמנת החתונה, 12.9.1960.**[[13]] המשפחה מסרה את ההזמנה המודפסת (13.09.2026), והיא קובעת את מה שעד כה היה "ספטמבר 1960" מן הזיכרון: «הורי הכלה **יקוט ושלום דהן**» ו«הורי החתן **יקוט ויונה בן-הרוש**» מזמינים לחופה «ביום שני, כ"א אלול תש"ך (**12.9.60**) בשעה 7.30 בערב ב**מועדון "ויצו" שכונת מונטיפיורי, רח' בית שמאי 8, תל-אביב**»; ובצרפתית «Jacot et Shalom Dahan» / «Jacot et Yona Benarosh … **MARIE et MARDOCHE**». מה היא מוסיפה: (1) **התאריך** — מאומת, ממסמך בן-הזמן; (2) **שמות הוריה של מרים**, בשני כתיבים, ממקור ישראלי — עד כה הם הופיעו רק בפנקסי אליאנס במכנאס ([3.1](#s3-1)); (3) הכינוי **MARIE** — כבפנקס 1949; (4) שני הצדדים כבר בתל אביב או בסביבתה ב-1960 (המען למברקים הוא אותו מועדון). דירוג: **מאומת**.

[![הזמנה לחתונת מרים ומרדכי, תל אביב 12.9.1960](docs/ev_wedding_1960_hebrew.jpg)](docs/1960-09-12_wedding_invitation.jpg)

*הנוסח העברי של ההזמנה. המקור: [באדיבות המשפחה](#src-13).*
