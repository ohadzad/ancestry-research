...
mlabel(1500, g1+PH/2+20, 'נשא גם את ריבקה גרוסמן, ומ-6.8.1884 את מינדל ברקוביץ (1865 – לפני 1944)')
...
c_ar = couple(1120, g3, ('m','אריה-לייב סטרולוביץ-רפפורט','נ׳ 3/1894 · נפ׳ 1944?','סוחר עורות; מת מרעב באושוויץ (עדות)'),
                        ('m','רבקה-רוזה פרקש','נ׳ 25.4.1904 · נפ׳ 1944','ככה"נ נרצחה בהגעה, 19.5.1944'),
...
d_ged  = box(890, g4, PW, PH, 's', 'גדליה (גיולה) רף', 'נ׳ 3.3.1931 · נפ׳ 2008', '⚭ חוה (יוכבד); ממקימי אילניה')
...
e3 = box(890, g5, PW+70, 72, 'u', 'אריה · זאב · רבקה ("ריקה")', 'ילדי גדליה וחוה · אילניה', 'ריקה: נ׳ 10.8.1958, נפלה בצה״ל 12.5.1977')
...
<div class="head">
  ...
  <div class="sub">משפחתה של רחל צדוק (״רוצי״), 16.04.1929 וולובה — 01/2021 חולון · שבעה דורות · קו הנישואין מסומן בין בני זוג, וילדים תלויים מקו האחים לפי סדר לידה · נערך 18.08.2026</div>
</div>
<div class="legend">
...
<div class="foot">
  ...
  מטעמי מקום אין העץ מציג את שאר ילדי גדליה רפפורט (שיינדל — מריבקה גרוסמן; נתן — אחיה המלא של שרה, בן אסתר כץ; ברטה, פרידריקה, זלמן, הרמן ומאיר — אחיו המלאים של אלדר ממינדל ברקוביץ) — פירוטם בפרק ב' של הדוח. רפפורט שאול (חברת רפסודות העצים של אוקרמזו-מיידנקה) אינו בעץ: קשרו המשפחתי המדויק טרם הוכח ברשומות.
