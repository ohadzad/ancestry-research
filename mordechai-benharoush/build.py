...
P = Person
PEOPLE = (
    P('מרדכי בן הרוש', '1931 – 2010', 'נושא הדף; "מרדושי"; בן יונה ויקוט (פנינה); עלה לבדו בעליית הנוער 1947/48; ככל הנראה "בנערוש מרדושי" ממגדים 1954 (מועמד ירושלים 1963 נשלל לפי מספר זהות)',
...
GALLERY = (
    ...
    (F.thumb(ROOT, 'docs/ev_yalkut_1964_row.jpg', 440), 'docs/yalkut_1144_p901.jpg', 'ילקוט הפרסומים 1144 — בן הראש מרדושה ← בן הראש מרדכי, ירושלים 1963, מס\' זהות 6419140 — מועמד שני, נשלל לפי מספר זהות'),
