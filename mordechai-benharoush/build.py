...
P = Person
PEOPLE = (
    P('מרדכי בן הרוש', '1927/28 (מסמכים) / 1931 (משפחה) – 2010', 'נושא הדף; "מרדושי"; בן יונה ויקוט (פנינה) לבית אוחיון; תעודת הקהילה וכתב העדות, מכנאס 1949–1950; עזב רווק ולבדו; רשומת רשפים 22.6.1949 (ככל הנראה); ככל הנראה "בנערוש מרדושי" ממגדים 1954',
...
cfg = ProjectConfig(
    ...
    meta_description=('דף מחקר על מרדכי בן הרוש, בן יונה ויקוט (פנינה), יליד מכנאס (1927/28 לפי המסמכים) שעלה לבדו — תעודת הקהילה וכתב העדות ממכנאס 1949–1950, משפחתו בפנקס אליאנס 1953 וברשימת "ארצה" 1956, המועמד ממושב מגדים 1954 (מועמד שני מירושלים 1963 נשלל לפי מספר זהות), ומה נשלל.'),
    report_md='report.md',
    ...
    spine=(
        SpineFact('3', 'מסמכים של מרדכי עצמו'),
