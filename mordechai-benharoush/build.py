...
P = Person
PEOPLE = (
    P('מרדכי בן הרוש', '1928 – 2010', 'נושא הדף; "מרדושי"; בן יונה ויקוט (פנינה) לבית אוחיון; תעודת הקהילה וכתב העדות, מכנאס 1949–1950; עזב רווק ולבדו; מעברת טירת הכרמל 1956; צו בית משפט 1990 — נולד 1928; רשומת רשפים 22.6.1949 (ככל הנראה); ככל הנראה "בנערוש מרדושי" ממגדים 1954',
...
cfg = ProjectConfig(
    ...
    spine=(
        SpineFact('6', 'מסמכים של מרדכי עצמו'),
