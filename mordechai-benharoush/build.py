...
P = Person
PEOPLE = (
    P('מרדכי בן הרוש', '1931 – 2010', 'נושא הדף; "מרדושי"; בן יונה ויקוט (פנינה); עלה לבדו בעליית הנוער 1947/48; שני מועמדים לרשומת שינוי השם — מגדים 1954 / ירושלים 1963 (טעון אימות)',
...
GALLERY = (
    ...
    (F.thumb(ROOT, 'docs/ev_yalkut_1964_row.jpg', 440), 'docs/yalkut_1144_p901.jpg', 'ילקוט הפרסומים 1144 — בן הראש מרדושה ← בן הראש מרדכי, ירושלים 1963, מס\' זהות 6419140 — המועמד השני'),
...
cfg = ProjectConfig(
    ...
    title='מרדכי בן הרוש',
    subject='1931, מכנאס — 2010 · דף נלווה למחקר על מרים בן הרוש · שתי רשומות של משפחתו · שני מועמדים לרשומת שינוי השם',
    meta_description=('דף מחקר על מרדכי בן הרוש, בן יונה ויקוט (פנינה), יליד מכנאס 1931 שעלה לבדו ב-1947/48 — משפחתו בפנקס אליאנס 1953 וברשימת "ארצה" 1956, שני מועמדים לרשומת שינוי השם (מגדים 1954, ירושלים 1963), ומה נשלל.'),
    report_md='report.md',
    ...
    spine=(
        ...
        SpineFact('2', 'מועמדים לרשומת שינוי השם'),
