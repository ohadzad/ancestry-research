...
P = Person
PEOPLE = (
    P('מרדכי בן הרוש', '1931 – 2010', 'נושא הדף; "מרדושי"; בן יונה ויקוט (פנינה); עלה לבדו בעליית הנוער 1947/48; ככל הנראה "בנערוש מרדושי" ממגדים 1954',
      '#s1', 'Mordechai Mordekhai Mardochée Ben Harush Benharoush Benharoch בנהרוש בן-הרוש בנערוש בנארוש הרוש מרדושי מגדים Megadim'),
    P('יונה בן הרוש', '1898? (משפחה), מכנאס', 'אביו; סוחר בעיר החדשה (פנקס 1953); עלה ב"ארצה" 11.6.1956 לצפת; בן מרדכי ומרים', '#s5-3', 'Yona Jonas Ben Harush בנארוש Benarroch ארצה צפת'),
    ...
    P('חנה (אנה?) ויוני (יונה) בן הרוש', '~1954 (יוני)', 'אשתו הראשונה של מרדכי ובנם (משפחה)', '#s6', 'Hana Anna Yoni Yona Ben Harush'),
