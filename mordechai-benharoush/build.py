...
PEOPLE = (
    ...
    P('יונה בן הרוש', '1898? (משפחה), מכנאס', 'אביו; מקצוע ההורים: סוחר, העיר החדשה (פנקס 1953); עלה ב"ארצה" 11.6.1956 לצפת; בן מרדכי ומרים', '#s5-3', 'Yona Jonas Ben Harush בנארוש Benarroch ארצה צפת'),
