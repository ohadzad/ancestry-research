...
שמונה מועמדים נשללו — ובהם זה שמירושלים — לפי שנת לידה, הורים, מוצא או מספר זהות (אחד מהם — ככל הנראה; אחד מהם מסכם 13 תוצאות אינדקס). **כל מסמך שנקרא מופיע פעמיים: קישור אל הרשומה בארכיון וקישור אל עותק שמור** (ערכי אינדקס וחיפושים מקוונים — בקישור חיצוני בלבד, ומסומנים ככאלה). גם ממצא שלילי נרשם, עם הכיסוי המדויק שלו.
...
- **יקוט (פנינה) בן הרוש** — אמו; ילידת 1918 (רשימת 1956); "יקוט" במרוקו ובמסמכים, "פנינה" בישראל (משפחה בלבד — ככל הנראה); עלתה עם יונה; תל אביב–יפו; קבורה בהר המנוחות (משפחה). פטירה — **טעון אימות**.
  ...
  - **מרדכי בן הרוש** — 1931 (משפחה; כנראה כך גם במשרד הפנים) – 2010 (משפחה). כינויו "מרדושי". עלה 1947/48 לבדו בעליית הנוער, בגיל 16–17, והתגייס מיד (משפחה; מתיישב עם הרשומות). ככל הנראה "מרדושי בנערוש" ממגדים (1954); "מרדושה בן הראש" מירושלים (1963) ככל הנראה נשלל לפי מספר זהות.
...
הרשימה המלאה ב[אינדקס המקורות](#index). ערך [1](#src-1) הוא המועמד לרשומת שינוי השם, וערך [13](#src-13) — מועמד שני באותו כינוי, שככל הנראה נשלל לפי מספר זהות; ערכים [2](#src-2), [3](#src-3), [5](#src-5), [6](#src-6), [8](#src-8), [11](#src-11) ו-[13](#src-13) נושאים את המועמדים שנשללו; ערכים [5](#src-5) ו-[9](#src-9) — הסריקות השליליות; ערך [7](#src-7) — מקור העזר על מגדים.

## 9. שיטה ומגבלות

### <span id="s9-1" class="legacy-anchor"></span>9.1 בסיס הראיות

ילקוט הפרסומים (מקור ראשוני מודפס — דרך סריקת IGRA, שמשחירה את עמודת מספרי הזהות בתמונות שהיא מגישה, ודרך סריקות הגיליונות המלאות באתר olaw.org.il, שבהן העמודה גלויה); רשימות העולים של ארכיון המדינה (מקור ראשוני שנקרא דרך OCR רועש); אינדקסים של IGRA (מקור עזר); מידע משפחתי ([פרק 2](#s2)).
