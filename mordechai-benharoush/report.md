...
- נישא למרים דהן (ילידת מכנאס, 1939; עלתה 1956) ב**תל אביב, ב-12.9.1960** — לפי הזמנת החתונה[[26]] — [המחקר על מרים](../index.html#research-miriam-benharoush).
...
**(י) הזמנה לחתונה — תל אביב, יום שני כ"א אלול תש"ך, 12.9.1960**[[26]] — הזמנה מודפסת דו-לשונית: «הורי הכלה **יקוט ושלום דהן**» ו«הורי החתן **יקוט ויונה בן-הרוש**» מזמינים ל«שמחת כלולות בניהם · **מרים** ע"ה **מרדכי** · החופה תתקיים אי"ה ביום שני, כ"א אלול תש"ך (**12.9.60**) בשעה 7.30 בערב ב**מועדון "ויצו" שכונת מונטיפיורי, רח' בית שמאי 8, תל-אביב** · אוטובוסים 54, 55»; ובצרפתית «Jacot et Shalom Dahan» / «Jacot et Yona Benarosh … **MARIE et MARDOCHE** … Lundi 12.9.60». **מה היא מוסיפה:** (1) **התאריך המדויק** — 12.9.1960 — במקום "ספטמבר 1960" שנמסר בעל פה: **מאומת**, ממסמך בן-הזמן. (2) **שמות ההורים משני הצדדים**, בשני כתיבים — יונה ויקוט בן הרוש מצד החתן: אישור **ישראלי** ובן-הזמן לשמות שעד כה הופיעו רק במסמכי מכנאס ובלסה-פסה ([ד](#s5-5), [ו](#s5-5), [ח](#s5-5)); ושלום ויקוט דהן מצד הכלה — כבפנקסי אליאנס ([5.2](#s5-2)). (3) **המקום** — מועדון "ויצו" בשכונת מונטיפיורי בתל אביב; ההזמנה מפנה מברקים לאותה כתובת, כלומר שני הצדדים כבר בתל אביב או בסביבתה ב-1960. (4) הכתיב **בן-הראש** בשורת המברקים — עוד גרסה לצד בן הרוש/בנארוש/Benarosh. דירוג: המסמך — **מאומת**; הזיהוי — **מאומת**.

[![הזמנה לחתונת מרים ומרדכי, תל אביב 12.9.1960 — הנוסח העברי](docs/ev_wedding_1960_hebrew.jpg)](docs/1960-09-12_wedding_invitation.jpg)

*הנוסח העברי של ההזמנה. המקור: [באדיבות המשפחה](#src-26).*
...
- **יקוט (פנינה) בן הרוש לבית אוחיון** — אמו; ילידת 1918 לפי רשימת 1956 — אינו מתיישב עם בן יליד 1928 ושני ילדים בכורים לפניו, **טעון אימות** ([5.3](#s5-3)); שם נעוריה אוחיון/חיון, בת דוד (מסמכי מכנאס 1949–1950); "יקוט" במרוקו ובמסמכים, "פנינה" בישראל (משפחה בלבד — ככל הנראה); עלתה עם יונה; תל אביב–יפו; קבורה בהר המנוחות (משפחה). פטירה — **טעון אימות**.
  ...
  - **מרדכי בן הרוש** — **1928** (צו בית משפט 1990; מסמכי מכנאס 1949–1950 ורשפים 1949: 1927/28; תעודת הזהות עד 1990: 1931) – 2010 (משפחה). מעברת טירת הכרמל, צריף 171 (אוגוסט 1956). כינויו "מרדושי". עזב את מכנאס רווק ולבדו (כתב העדות 1949 — מאומת); לפי המשפחה 1947/48 בעליית הנוער; לפי רשומת רשפים (ככל הנראה) הגיע 22.6.1949 ויצא לצבא. ככל הנראה "מרדושי בנערוש" ממגדים (1954); "מרדושה בן הראש" מירושלים (1963) ככל הנראה נשלל לפי מספר זהות.
    ...
    - נישואין שניים: **מרים לבית דהן** (1939, מכנאס), תל אביב, **12.9.1960** (הזמנת החתונה[[26]]) — [המחקר על מרים](../index.html#research-miriam-benharoush).
...
| 2א | **תעודת הנישואין של מרדכי ומרים** — התאריך והמקום ידועים מהזמנת החתונה ([י](#s5-5)); חסרה התעודה עצמה | רישומי הרבנות תל אביב (תעודת נישואין: שנות לידה, שמות הורים, כתובות); עיתונות ספטמבר 1960 | משפחה (תעודה בבית?) / ארכיון |
