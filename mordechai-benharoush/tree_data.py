...
nodes = [
    ...
    N('yakut',      4, 1, 'יקוט (פנינה) לבית אוחיון', ['1918 (רשימה — טעון אימות) · "ארצה" 1956 → צפת', '"פנינה" — משפחה · ת"א · הר המנוחות']),
    ...
    N('mordechai',  2, 2, 'מרדכי בן הרוש', ['1928 (צו בימ"ש 1990) – 2010', 'מכנאס · "מרדושי" · טירת הכרמל 1956'], focus=True),
