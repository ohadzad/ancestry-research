...
nodes = [
    ...
    N('yona',       3, 1, 'יונה בן הרוש',  ['1898 (משפחה) / 1912–18 (רשימה)', 'הורים סוחרים, מכנאס · צפת, ת"א · הר המנוחות']),
    N('yakut',      4, 1, 'יקוט (פנינה) בן הרוש', ['1918 · "ארצה" 1956 → צפת', 'ת"א · הר המנוחות']),
    N('nissim',     0, 2, 'ניסים (מקסים)', ['הבכור · לא עלה', 'לפי המשפחה'], dashed=True),
    N('miriam1',    1, 2, 'מרים',          ['לא עלתה', 'לפי המשפחה'], dashed=True),
    N('mordechai',  2, 2, 'מרדכי בן הרוש', ['1931–2010 · מכנאס · "מרדושי"', 'עלה לבדו 1947/48, עליית הנוער'], focus=True),
...
tree = Tree(
    ...
    title='עץ המשפחה — מרדכי ומרים בן הרוש; יונה ויקוט (פנינה) בן הרוש ותשעת ילדיהם — ניסים (מקסים), מרים, מרדכי, יעקב, גבריאל, ז\'וליט, סלומון, אסתר ומיכאל מכלוף; נשותיו של מרדכי חנה ומרים לבית דהן, ובנו יוני; אשתו של יעקב מרי',
)
