...
tree = Tree(
    ...
    title='עץ המשפחה — מרדכי ומרים בן הרוש, דוד אוחיון; יונה ויקוט (פנינה) בן הרוש לבית אוחיון ותשעת ילדיהם — ניסים (מקסים), מרים, מרדכי, יעקב, גבריאל, ז\'וליט, סלומון, אסתר ומיכאל מכלוף; נשותיו של מרדכי חנה ומרים לבית דהן, ובנו יוני; אשתו של יעקב מרי',
)
