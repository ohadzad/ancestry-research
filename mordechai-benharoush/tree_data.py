...
nodes = [
    ...
    N('yona',       3, 1, 'יונה בן הרוש',  ['1898? · 1912/1918 ברשימה', 'סוחר, מכנאס · צפת · ת"א']),
    N('yakut',      4, 1, 'יקוט (פנינה) אוחיון', ['1918 ברשימה — טעון אימות', '"פנינה" בפי המשפחה · צפת · ת"א']),
    ...
    N('mordechai',  2, 2, 'מרדכי בן הרוש', ['1928 (צו בימ"ש 1990) – 2010', 'מכנאס · "מרדושי" · טירת הכרמל'], focus=True),
