...
<div class="head">
  ...
  <div class="sub">משפחתה של רחל צדוק (״רוצי״), 16.04.1929 וולובה — 01/2021 חולון · שבעה דורות · קו הנישואין מסומן בין בני זוג, וילדים תלויים מקו האחים לפי סדר לידה · נערך 26.08.2026</div>
</div>
<div class="legend">
