...
mlabel(1345, g1+PH/2+16, 'נשא גם את ריבקה גרוסמן, ומ-6.8.1884 את מינדל ברקוביץ (1865 – לפני 8.1944)')
...
kids_g = [
 ...
 ('u','יוסף-דוד?','נ׳ 1891','זיהוי משוער (דף עד: אביו "גדלי")|נספה באושוויץ 1942'),
...
box(890, g4, PW, PH, 's', 'גדליה (גיולה) רף', 'נ׳ 3.3.1931 · נפ׳ 2008', '⚭ חוה (יוכבד); ממקימי אילניה')
...
box(890, g5, PW+70, 72, 'u', 'אריה · זאב · רבקה ("ריקה")', 'ילדי גדליה וחוה · אילניה', 'ריקה: נ׳ 10.8.1958, נפלה בצה״ל 12.5.1977')
...
<div class="head">
  ...
  <div class="sub">כל בני המשפחה המתועדים, כולל ילדי גדליה רפפורט מכל נשותיו וילדי האחים · משפחתה של רחל צדוק (״רוצי״), 16.04.1929 וולובה — 01/2021 חולון · נערך 18.08.2026</div>
</div>
<div class="legend">
