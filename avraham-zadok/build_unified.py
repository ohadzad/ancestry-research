...
EVID = [
    ...
    dict(crop="docs/evidence/mitteiman_letzion_1938.png",
         ...
         cap="מודעת הקובץ המדעי-תרבותי «מתימן לציון» על יהדות תימן; רשימת המשתתפים (לפי א\"ב) כוללת את «אהרן צדוק» לצד ש\"ד גויטין, ישראל ישעיהו, אברהם יערי ומנשה רבינא. הצמד ישעיהו + אהרן צדוק חוזר גם ב«שבות תימן» (1945) ומלכד את הזיהוי; מקדים אותו בשבע שנים. במהדורה 60 נודע גם שם חיבורו בקובץ — «חבלי עליה», סיפורים — מתוכן הקובץ שנדפס ב«דבר» 6.5.1938, ושם נודע גם שעורכי 1938 היו ישעיהו ושמעון גרידי ואהרון היה בו משתתף ולא עורך. (דירוג: קיום החיבור ושם מחברו — מאומת; זהות המחבר עם אהרון — כמעט ודאי, שכן אין בפריט מקום ולא מקצוע.)"),
    ...
    dict(crop="docs/evidence/davar_1945_mikveh_zadok_shapira.png",
         full="docs/jpress/issues/davar_1945-04-25.pdf",
         ext="https://www.nli.org.il/he/newspapers/?a=d&d=dav19450425-01.2.55",
         title="«מקוה ישראל — אהרון צדוק, יוסף שפירא» — «דבר», 25.4.1945",
         cap="עמוד 4, ברשימת נציגי היישובים שנדפסה חמישה ימים אחרי הוועידה השישית של הסתדרות הפועלים החקלאים: «רחובות — י. חורין. · גן יבנה (יום ה\') — י. פוגל; · <strong>מקוה ישראל — אהרון צדוק, יוסף שפירא</strong>.» זהו הפריט <strong>החמישי</strong> בקורפוס שנוקב את יישובו של אהרון לצד שמו — ולכן אחד מאלה שבהם הזיהוי מאומת ולא רק כמעט ודאי; האחרים הם «דבר» 1929, «הצפה» 1943, צוואת מרגולין 1947 ו«למרחב» 1960. השורה אותרה על הדף בעזרת שכבת ה-bbox של קובץ ה-PDF ואז נקראה בהגדלה. (דירוג: מאומת.)"),
    dict(crop="docs/evidence/almishmar_1945_yoshev_rosh_zadok.png",
         full="docs/jpress/issues/almishmar_1945-04-20.pdf",
         ext="https://www.nli.org.il/he/newspapers/?a=d&d=ahr19450420-01.2.75",
         title="«ישיבת אחר-הצהרים התחילה בשעה 4. ישב ראש אהרן צדוק» — «על המשמר», 20.4.1945",
         cap="עמוד 8 של הגיליון, בדיווח מן הוועידה השישית של הסתדרות הפועלים החקלאים. השורה נקראה בעיניים לאחר עיבוד תמונה: «ישיבת אחר-הצהרים התחילה בשעה 4. <strong>ישב ראש אהרן צדוק</strong>. בישיבה נמשך הויכוח על בעיות ההתישבות. דיברו: מ. גלר (כפר יהושע), פ. זומר... קולר (גבע), נחומי (משמר השרון)... מ. שגור (כפר עזיב)». עד מהדורה 62 ידע הקורפוס שאהרון היה <strong>מועמד</strong> באותה ועידה — מספר 46 בטור ה«סגנים» של מפא\"י; כאן מתברר שהוא <strong>ישב בראש אחת מישיבותיה</strong>, לצד נציגי קיבוצים ומושבים ותיקים. וחמישה ימים אחר כך נדפסה ב«דבר» רשימת הנציגים לפי יישוב, ובה «מקוה ישראל — אהרון צדוק, יוסף שפירא». (דירוג: השורה — מאומת, נקראה בעיניים; זיהוי הנקוב בה עם אהרון — מאומת, שכן «מקוה ישראל» נדפס לצד שמו ברשימת «דבר» מאותה ועידה.)"),
    ...
    dict(crop="docs/evidence/igra_1912_rahamim_ben_azar_foil_zoom.png",
         full="docs/igra/igra_foil43_1912_rahamim_ben_azar_arwas.jpg",
         ext="https://genealogy.org.il/AID/index.php?recordID=SUdSQS0xODY1LTE5MTQtQnJpdGlzaE5hdFJlZ2lzdEphZmZhLTIwODQ=",
         title="טופס 43, יפו, 31.1.1912 — «Rahmim Arwas · Father: Azar Arwas (deceased)» · «British Subject (Gibraltar)»",
         cap="«Name: Rahmim Arwas · Country: Palestine · Village or Town: Jaffa · Father's Name and Residence: <strong>Azar Arwas (deceased)</strong> · Occupation: Merchant · Age: <strong>48</strong>», ובהערות הפקיד: «<strong>British Subject (Gibraltar)</strong> · Previous Certificate N° 28 of January 10. 1911 · <strong>Esther — wife — Age 26</strong>». שני דברים: <strong>רחמים הוא בנו של אזר</strong> — אותו אב שבטופסי יעקב מ-1896 ומ-1902 — ומכאן שהשניים <strong>אחים</strong>, ולענף אלעזר שלושה בנים מתועדים בשם אביהם: יוסף אליהו (~1856), רחמים (~1864) ויעקב (~1865). ו<strong>«British Subject (Gibraltar)» הוא האזכור המפורש הרביעי של גיברלטר בקורפוס</strong> — לצד שורת 1839, מפקד 1855 ו«Orig. from Gibraltar» מ-1904 — והשני מהם הנוגע לענף אלעזר דווקא. רחמים נרשם כמעט מדי שנה מ-1904 עד 1914. ארכיון המדינה; IGRA 2084. (דירוג: תוכן הטופס — מאומת; רחמים ויעקב כאחים — כמעט ודאי; «Gibraltar» כמוצא ולא רק כנתינות — ככל הנראה.)"),
    dict(crop="docs/evidence/igra_1903_solomon_ben_yosef_foil_zoom.png",
         full="docs/igra/igra_foil31_1903_solomon_ben_yosef_arwas.jpg",
         ext="https://genealogy.org.il/AID/index.php?recordID=SUdSQS0xODY1LTE5MTQtQnJpdGlzaE5hdFJlZ2lzdEphZmZhLTU4Mw==",
         title="טופס 31, יפו, 20.3.1903 — שלמה בן יוסף, בן 28, ובלי בני בית",
         cap="«Solomon Arruas · Palestine · Jaffa · Father's Name and Residence: <strong>Yousef Arruas (dead)</strong> · Occupation: <strong>Farmer</strong> · Age: <strong>28</strong>», וההערות ריקות. הטופס חוזר על טופס 1902 ומוסיף בקרה פנימית נקייה — בן 27 במרץ 1902, בן 28 במרץ 1903 — ושנת הלידה ~1874/5 מתייצבת. <strong>והממצא השלילי:</strong> בשני הטפסים אין רשימת בני בית, בעוד באותו פנקס עצמו רשם הפקיד בני בית בעקביות (אליהו 1893, יוסף 1893, מיכאל 1895 · 1903 · 1906, רחמים 1912) — כלומר שלמה בן יוסף היה <strong>עדיין רווק במרץ 1903</strong>. אם הוא אביו של מרקו יליד מצרים 1916, נישואיו חלו בין 1903 ל-1915 — צמצום חלון ליעד T22. ארכיון המדינה; IGRA 583. (דירוג: תוכן הטופס — מאומת; היעדר בני בית כעדות לרווקות — ככל הנראה.)"),
    dict(crop="docs/evidence/igra_1898_index_arwas_lines_zoom.png",
         full="docs/igra/igra_britHebNabJer_039_1898_index.jpg",
         ext="https://genealogy.org.il/AID/index.php?recordID=SUdSQS0xODM4LTE5MDgtQnJpdEhlYk5hYkplci0zODU2",
         title="אינדקס פנקס ההרשמה, 1898 — «Arrwas — Moshie, son of Eliaho — B.S. — 96»",
         cap="עמוד אינדקס אלפביתי של פנקס ההרשמה השנתי של נתיני בריטניה. ארבע שורות ארואס: «<strong>Arrwas — Moshie, son of Eliaho</strong> — B.S. — 96», «Arrwas — Eliyaho — B.S. — 98», «Arrowas — Jacob — B.S. — 123», «Arrwas — Abraham — 124». <strong>הפטרונים הוא הממצא:</strong> האינדקס מוסיף «son of» רק כשהוא נחוץ להבחנה — כך גם בשורה הסמוכה, «Amzalak David, son of Solomon» — ומכאן שב-1898 נרשם בקונסוליה, בזכות עצמו, <strong>משה בן אליהו ארואס</strong>; ולנו יש בדיוק אדם כזה, משה בן 17 ברשימת בני ביתו של אליהו בן שלמה בעזה ב-1893, כלומר יליד ~1876 ובן ~22 כאן. <strong>אברהם, לעומתו, רשום בלי פטרונים</strong> בשני האינדקסים. העמוד התקבל בדואר מוועדת הוובמאסטר של IGRA (24.8.2026), שכן תמונות האוסף מוחזרות ב-403. (דירוג: תוכן השורות — מאומת; זיהוי משה — כמעט ודאי; שם אביו של אברהם — בלתי ידוע.)"),
    dict(crop="docs/evidence/igra_1896_index_arwas_lines_zoom.png",
         full="docs/igra/igra_britHebNabJer_036_1896_index.jpg",
         ext="https://genealogy.org.il/AID/index.php?recordID=SUdSQS0xODM4LTE5MDgtQnJpdEhlYk5hYkplci0zNjI4",
         title="אינדקס פנקס ההרשמה, 1896 — «Arrowas — Eliyaho — 87» · «Arrwas — Abraham — 88»",
         cap="שנתיים קודם, אותו פנקס: אליהו ואברהם רשומים בשורות עוקבות, שניהם B.S., ושניהם <strong>בלי פטרונים</strong>. שימו לב לכתיב — <strong>Arrowas</strong> אצל אליהו כאן ו-<strong>Arrwas</strong> אצל אברהם, ובאינדקס 1898 להפך; ארבעה כתיבים משמשים בערבוביה באותו פנקס עצמו (ובאוסף יפו גם Arwas ו-Arruas), ולכן הכתיב אינו סימן מבחין בין אנשים. עוד: מספר ההרשמה משתנה משנה לשנה — אליהו הוא 87 כאן ו-98 ב-1898 — ולכן «מסמך 96» שברשומות IGRA הוא מספר שנתי ולא מזהה קבוע של אדם. (דירוג: תוכן השורות — מאומת.)"),
    dict(crop="docs/evidence/igra_1896_jacob_ben_azor_foil_zoom.png",
         full="docs/igra/igra_foil27_1896_jacob_ben_azor_arwas.jpg",
         ext="https://genealogy.org.il/AID/index.php?recordID=SUdSQS0xODY1LTE5MTQtQnJpdGlzaE5hdFJlZ2lzdEphZmZhLTIxNw==",
         title="טופס 27, יפו, 22.4.1896 — «Jacob Arrwas · Father's Name: Azor Arrwas (dead)»",
         cap="«Name: Jacob Arrwas · Country: Palestine · Village or Town: Jaffa · Father's Name and Residence: <strong>Azor Arrwas (dead)</strong> · Residence of Applicant: Jaffa · Occupation: <strong>Matrass maker</strong> · Age: <strong>31</strong>». במהדורה 47 שויך יעקב לענף אלעזר <strong>על סמך המקצוע בלבד</strong> — אלעזר ארואץ עסק במזרנים ביפו לפי מפקד 1855 — ודורג «ככל הנראה»; כאן שם האב עומד ברשומה. בטופסו השני, מ-11.7.1902, נכתב «Father's Name: <strong>Azar</strong>» והמקצוע כבר «Merchant», בגיל 37. הכתיב Azor/Azar הוא אותו גלגול שמות המתועד בענף — <strong>אלעזר · עזר · אזר</strong> — החוזר גם בדור הבא (אזר בן יוסף אליהו, עזה 1904). גיל 31 גוזר לידה ~1865 ביפו. ארכיון המדינה, מסמך 27; IGRA 217. (דירוג: תוכן הטפסים — מאומת; זיהוי אזר עם אלעזר של 1855 — כמעט ודאי, עלייה מ«ככל הנראה» של מהדורה 47.)"),
...
dict(crop="docs/family_docs/israelalbum/ia_012_yitzhak_grandchildren_1936.jpg",
    ...
    dict(crop="docs/evidence/isa_britreg_1866_arwas_yusef.png",
         full="docs/isa/isa_sal1544_britreg_pages22-24.pdf",
         ext="https://www.archives.gov.il/details/0013z0q",
         title="«Arwas · Yusef · 1866 · 7» — הרשומה הקונסולרית המוקדמת ביותר בקורפוס",
         cap="ארכיון המדינה, סל-1544/1, עמוד 22: האינדקס האלפביתי של פנקסי הקונסוליות הבריטיות בארץ ישראל. העמודות: «Name — First registered: Year, No. — Remarks». השורה נקראה אות-אות מן הסריקה: Arwas, Yusef, נרשם לראשונה ב-1866, מספר 7. עד כה הייתה הרשומה המוקדמת ביותר של יוסף ארואס — אביה של מרים — רישום 1869 (בן 24), ואחריו טופס 1893 (בן 41). רישום עצמאי ב-1866 מטה את מתח שנת הלידה לטובת ~1845: לפי הקריאה המאוחרת היה אז בן ארבע-עשרה, ונער בגיל זה אינו נרשם בקונסוליה בזכות עצמו. (דירוג: תוכן השורה — מאומת; זיהויו עם יוסף אבי-מרים וההטיה לטובת ~1845 — ככל הנראה.)"),
    dict(crop="docs/evidence/isa_britreg_1887_arwas_abraham_eliyaho.png",
         full="docs/isa/isa_sal1544_britreg_pages22-24.pdf",
         ext="https://www.archives.gov.il/details/0013z0q",
         title="1887 — אברהם 14, אליהו 133 ואברם 134: שנת הרישום הראשון, ומספרים עוקבים",
         cap="ארכיון המדינה, סל-1544/1, עמוד 23. שלוש שורות מ-1887: «Arruas — Abraham — 1887 — 14» (הערה: Arrwa[s]…), «Arwas — Eliyaho — 1887 — 133» (הערה: Arrowas 9[?]) ו«Arwas (Arruas) — Abram (Abraham) — 1887 — 134» (הערה: See Raw…). שתי תוצאות: אברהם ארואס נרשם לראשונה ב-1887 ולא ב-1890 כפי שנרשם בקורפוס עד כה; ואליהו (133) ואברהם (134) נושאים מספרים עוקבים באותה שנה, כלומר נרשמו ככל הנראה יחדיו ובאותו מעמד. אליהו הוא אליהו בן שלמה, פרנס עדת עזה, לפי טופס 24 מ-1893. (דירוג: תוכן השורות — מאומת, נקראו בעיניים; «רישום עוקב = קרבת משפחה» — ככל הנראה; קרבת אברהם לאליהו — טעון אימות, ואינה נטענת. ההכרעה תבוא מטופסי הרישום עצמם — מספרים 14, 133 ו-134 של 1887.)"),
    dict(crop="docs/evidence/isa_britreg_1891_1897_arwas.png",
         full="docs/isa/isa_sal1544_britreg_pages22-24.pdf",
         ext="https://www.archives.gov.il/details/0013z0q",
         title="1891-1897 — מיכאל 95 ויוסף אליהו 96, יעקב 81 ומשה 107",
         cap="ארכיון המדינה, סל-1544/1, עמוד 23, המשך שורות ארואס: «Arrowas — Michel — 1891 — 95», «Arrowas — Joseph Eliaho — 1891 — 96» (הערה: Arrwas 104/99), «Arrowas — Jacob — 1894 — 81» ו«Arrwas — Moshé — 1897 — 107». שלוש הקדמות מול הקורפוס: מיכאל מוקדם בארבע שנים מטופס 16 של 1895, יוסף אליהו בשנתיים מרישום 1893, ויעקב בשנתיים מטופס 27 של 1896. וחשוב מכך: מיכאל (95) ויוסף אליהו (96) — שני בני-דודים המוכרים לקורפוס — נושאים מספרים עוקבים באותה שנה, וזו הצמדה שממנה נלמד הכלל שרישום עוקב מציין בני משפחה שבאו יחדיו. (דירוג: תוכן ארבע השורות — מאומת, נקראו בעיניים.)"),
    dict(crop="docs/evidence/isa_britreg1886_arwas_eliaho.png",
         full="docs/isa/isa_sal1544_britreg_1886_1899_1895_1887.pdf",
         ext="https://www.archives.gov.il/details/0013z0q",
         title="10.2.1886 — «Eliaho Arowas · 30 · Moneychanger» ומשק ביתו",
         cap="ארכיון המדינה, סל-1544/1: «Register of British Subjects in the Consular District of Jaffa», שנת 1886. רישומים 48-52, כולם מ-10 בפברואר: Eliaho Arowas, Palestine, Jaffa, בן 30, Moneychanger; ואחריו Oro (25), Moses (12), Rachel (10) ו-Mariam (7) בסימני «ditto» של שם המשפחה. אליהו — הוא ככל הנראה אליהו בן שלמה, פרנס עדת עזה שבטופס 24 מ-1893 — רשום כאן במקצוע שרשומת 1869 נוקבת ליוסף: חלפן כספים. (דירוג: השורות — מאומת, נקראו בעיניים; שיוכן למשק בית אחד — ככל הנראה, שכן סימני ה-ditto מציינים שם משפחה ולא שיוך בית.)"),
    dict(crop="docs/evidence/isa_britreg1886_arwas_joseph_michel.png",
         full="docs/isa/isa_sal1544_britreg_1886_1899_1895_1887.pdf",
         ext="https://www.archives.gov.il/details/0013z0q",
    ...
    dict(crop="docs/evidence/isa_britreg1899_michel_arwas.png",
         full="docs/isa/isa_sal1544_britreg_1886_1899_1895_1887.pdf",
         ext="https://www.archives.gov.il/details/0013z0q",
         title="1899, רישום 17 — «Michel Arwas · Palestine · Jaffa · 35 · Trader»",
         cap="אותו פנקס, שנת 1899: «17 · [Feb.] 13 · Michel Arwas · Palestine · Jaffa · 35 · Trader», ובשורות שמעליו Bension Amzalak (36, Merchant) ו-Isaac (39, Money Changer) — משפחת אמזלג מגיברלטר, המוכרת לקורפוס מעמוד 1839 של פנקס ירושלים ומן ההתראה על «Bension Arrwas» שהתברר כאמזלג. מיכאל בן 35 ב-1899 ⇒ יליד ~1864, מול בן 20 ב-1886 ⇒ ~1866: סטייה של שנתיים בין שתי הצהרות. (דירוג: השורה — מאומת, נקראה בעיניים; זיהויו עם מיכאל בן שלמה — כמעט ודאי.)"),
    dict(crop="docs/evidence/isa_foil1887_no14_bradley.png",
         full="docs/isa/isa_sal1544_britreg_1886_1899_1895_1887.pdf",
         ext="https://www.archives.gov.il/details/0013z0q",
         title="הבדיקה השלילית — טופס מס' 14 של 1887 אינו ארואס אלא Miss Ina Bradley",
         cap="סל-1544/1, עמוד 925 בקובץ («Page 76» בכרך): «Her Majesty's Consulate — Jaffa — Foil of Certificate of Registration. <strong>No. 14 · 11th of June 1887</strong> · 1. Name: Miss Ina Bradley · 2. Country: England · 3. Village or Town: London · 4. Father's Name and Residence: Thomas Bradley (dead) · 5. Residence of Applicant: Jaffa · 6. Occupation: Missionary · 7. Age: 29». מהדורה 68 הסיקה שהמספר «14» שליד אברהם ארואס באינדקס הוא מספר טופס; הטופס נפתח — והוא של אישה אנגלייה. כלומר מספרי האינדקס הם מספרי <strong>פנקס נתיני בריטניה</strong>, לא מספרי הטפסים. הראיה נשמרת מפני שהיא מונעת חיפוש שווא של מאות עמודים. (דירוג: מאומת — נקרא בעיניים.)"),
    dict(crop="docs/evidence/isa_1895_jerusalem_rawas_declaration.png",
         full="docs/isa/isa_sal1544_britreg_1886_1899_1895_1887.pdf",
         ext="https://www.archives.gov.il/details/0013z0q",
