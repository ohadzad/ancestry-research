...
**מסמך מחקר מתועד ומקושר־מקורות · מהדורה 41 · אלול תשפ״ו / אוגוסט 2026**
...
*הפרק הזה הוא "מאחורי הקלעים" של המסמך: על מה הוא נשען, איך מדורגת כל טענה, ומה הוא אינו יודע. הוא מובא בסופו ולא בפתיחתו, כדי שהקורא יגיע קודם אל הממצאים. סך המקורות שעליהם נשען המסמך: <strong>40</strong> — רשומות מדינה מארכיון המדינה, מפקדים ארכיוניים בני-הזמן, רישומי קונסוליה, עיתונות בת-הזמן, ספרות עיון, מקור ראשוני בגוף ראשון ומסירה משפחתית בעל-פה.*
...
רשימת המקורות המלאה — 40 ערכים — מופיעה בסוף המאמר. כל ערך כולל את מהות המקור, הפניה חיצונית למסמך המקורי, עותק מקומי שנשמר בתיקיית המחקר, ותיאור מה בדיוק הוא מוכיח — ובארבעה ערכים חסר אחד משני הקישורים, והדבר מצוין בערך עצמו. ערך שאינו מצוטט בגוף המאמר מסומן ככזה.
...
- **נספח ב — גלריית הראיות.** [32 ראיות מצולמות](#evidence); לכל ראיה עותק מקומי, ולרובן גם המסמך המקורי באתר המקור.
- **נספח ג — רשימת המקורות.** [40 ערכי מקור](#sources) עם מהות, קישור חיצוני, עותק מקומי (בארבעה ערכים אחד מהשניים חסר, כמצוין בהם) ומה כל מקור מוכיח, וכן רשימת הממצאים השליליים המתועדים.
