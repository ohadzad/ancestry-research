...
c_ag = 1100
s,_ = couple(c_ag, yG, "יוסף ארואס", "~1843/45 · צראף ביפו · קונסוליה 1869|נפ׳ יפו 1894? (גאון)", "גרסיה ארואס", "אם מרים", "arwas"); S.append(s)
x_avf = 1440
...
S.append(f'<text class="gen" x="1020" y="754" text-anchor="middle">{esc("שכבות שנוספו במהדורות 43-47 — מתועדים ברשומת מדינה, החוליה לעץ עדיין פתוחה")}</text>')
