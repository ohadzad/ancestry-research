...
aharon_c = 596
S.append(box(aharon_c, y1, "אהרון צדוק", "~1895 - 18.11.1981 · יליד צנעא|עלה 1914 · יפו 1918: פועל תימני|אופה ומזכיר הפועלים · חולון", "parent"))
...
<div class="legend">
 ...
 <ul>
  ...
  <li><b>צד האב</b> — זיכרונות אהרון צדוק ומכתבו לנכדו (מקור ראשוני): לידה בצנעא (~1895-1898, המקורות חלוקים; בתיבה ננקב ~1895 על פי גיל 86 שברשומת הקבורה — מהדורה 38 — ובספר), משפחת צאלח, פטירת האב בעדן, רעב 1904, עלייה 1914. שם הסב אברהם — פנקס הבוחרים 1949 וכתובת אהרן ורוזה (מסמך ראשוני, מהדורה 35) — מאומת; שם הסבתא סעדה — MyHeritage + ספר המשפחה (שני מקורות משפחתיים לא בלתי-תלויים), ככל הנראה; האח יוסף, שנספה עם אמו — ספר המשפחה. <b>מהדורה 59:</b> רשומת פנקס תושבי יפו 1918-1919 (משק בית 685/2) נקראה אות-אות מן הסריקה — «צאלח · אהרן · רוק · 23», ובנוסף העדה «תימני» והמקצוע «פועל»; זו הרשומה החיצונית המוקדמת ביותר של אהרון, והזיהוי עלה ל<b>כמעט ודאי</b>.</li>
