...
S.append(box(moshe_c, yG, "משה · מיכאל", "בני שלמה|משה ~1849|(מפקד 1855)|מיכאל ~1864|«בן Solomon,|deceased» 1904", "arwas", w=112, h=124))
...
S.append(f'<text class="gen" x="1020" y="754" text-anchor="middle">{esc("שכבות שנוספו במהדורות 43-50 — מתועדים ברשומת מדינה, החוליה לעץ עדיין פתוחה")}</text>')
...
<div class="legend">
 ...
 <ul>
  ...
  <li><b>ילדיהם של האחים (מהדורה 54).</b> טפסי הקונסוליה נוקבים גם בבני הבית. אצל <b>מיכאל בן שלום</b> ביפו: 1895 — רעייתו <b>רחל</b> (30), <b>בן ציון</b> (7) ו<b>פרידה</b> (4); 1903 — רעייתו <b>אטה</b> (20), בן ציון (14), פרידה (11), <b>רבקה</b> (6), <b>רחל</b> (3) ו<b>יוסף</b> (1). ואצל <b>אליהו</b> בעזה, 1893: פרו, משה, רחל, מרים, סולטנה, יעקב ושלמה. תבנית שחוזרת בשני הבתים: גיל הרעיה נמוך מכדי שתהיה אמם של הבכורים — הקונסוליה רשמה את הרעיה הנוכחית ואת כל ילדי האיש.</li>
